      ...
      line_items: [
        {
          price_data: {
            ...
            unit_amount: Math.round(event.price * 100), // Stripe expects the amount in cents
          },
          quantity: 1,
        },
      ],
      payment_intent_data: {
        application_fee_amount: Math.round(event.price * 100 * 0.01), // 1% fee for the person who sells the tickets
      },
