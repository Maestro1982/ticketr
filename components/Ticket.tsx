...
export const Ticket = ({ ticketId }: { ticketId: Id<'tickets'> }) => {
      ...
      <div className='relative'>
        ...
        >
          ...
          {ticket.event.is_cancelled && (
            <p className='text-red-300 mt-1'>This event is cancelled.</p>
          )}
        </div>
      </div>
        ...
        <div className='grid grid-cols-2 gap-6'>
          ...
          <div className='space-y-4'>
            <div className='flex items-center text-gray-600'>
              <CalendarDays
                className={`size-5 mr-3 ${ticket.event.is_cancelled ? 'text-red-600' : 'text-blue-600'}`}
              />
              <div>
